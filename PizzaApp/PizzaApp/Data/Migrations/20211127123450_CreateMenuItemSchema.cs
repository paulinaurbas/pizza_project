...
{
    public partial class CreateMenuItemSchema : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdditionalPrice = table.Column<double>(type: "float(2)", precision: 2, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuItemDishes", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RestaurantMenuItems_MenuItems_MenuItemId",
                        column: x => x.MenuItemId,
                        principalTable: "MenuItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DishIngredients_IngredientId_DishId",
                table: "DishIngredients",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItemDishes_MenuItemId_DishId",
                table: "MenuItemDishes",
                columns: new[] { "MenuItemId", "DishId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RestaurantIngredients_RestaurantId_IngredientId",
                table: "RestaurantIngredients",
                columns: new[] { "RestaurantId", "IngredientId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RestaurantMenuItems_MenuItemId",
                table: "RestaurantMenuItems",
                column: "MenuItemId");

            migrationBuilder.CreateIndex(
                name: "IX_RestaurantMenuItems_RestaurantId_MenuItemId",
                table: "RestaurantMenuItems",
