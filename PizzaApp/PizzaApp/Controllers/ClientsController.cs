...
namespace PizzaApp.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Surname,Address,Email,Telephone")] Client client)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Surname,Address,Email,Telephone")] Client client)
        {
            if (id != client.Id)
            {
                return NotFound();
